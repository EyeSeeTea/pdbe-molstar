...
export class PDBeViewportControls extends ViewportControls {
    ...
    render() {
        ...
        if (
            ...
            customeState.initParams.pdbeLink
        )
            showPDBeLink = true;
        if (
            customeState &&
            customeState.initParams &&
            customeState.initParams.superposition
        )
            showPDBeLink = false;
        if (
            customeState &&
            ...
            <>
                {showPDBeLink && (
                    <div
                        ...
                        style={pdbeLink.containerStyle}
                    >
                        <div
                            className="msp-semi-transparent-background"
                            style={pdbeLink.bgStyle}
                        />
                        <a
                            className="msp-pdbe-link"
                            style={pdbeLink.style}
                            target="_blank"
                            href={`https://pdbe.org/${customeState.initParams.moleculeId}`}
                        >
                            <img
                                src={pdbeLink.pdbeImg.src}
                                alt={pdbeLink.pdbeImg.alt}
                                style={pdbeLink.pdbeImg.style}
                            />
                            {customeState.initParams.moleculeId}
                        </a>
                    </div>
                ...
                <div
                    ...
                    style={showPDBeLink ? vwpBtnsTopMargin : void 0}
                >
